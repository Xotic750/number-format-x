/*!
{
  ...
  "date": "2019-08-19T22:33:43.694Z",
  "describe": "",
  "description": "Format a number.",
  "file": "number-format-x.js",
  "hash": "78793939e5dd5b19bfc3",
  "license": "MIT",
  "version": "4.1.0"
}
*/
(function webpackUniversalModuleDefinition(root, factory) {
	if(typeof exports === 'object' && typeof module === 'object')
		...
		exports["numberFormatX"] = factory();
	else
		root["numberFormatX"] = factory();
})((function () {
  'use strict';
...
// CONCATENATED MODULE: ./node_modules/number-to-decimal-form-string-x/dist/number-to-decimal-form-string-x.esm.js

var number_to_decimal_form_string_x_esm_castNumber = 0 .constructor;
var emptyString = '';
var number_to_decimal_form_string_x_esm_charAt = emptyString.charAt,
    slice = emptyString.slice,
    search = emptyString.search,
    number_to_decimal_form_string_x_esm_replace = emptyString.replace,
...
var number_to_decimal_form_string_x_esm_test = isValid.test;
...
var number_to_decimal_form_string_x_esm_toDecimalFormString = function toDecimalFormString(value) {
  ...
  if (workingValue === 0 && 1 / workingValue < 0) {
    ...
    if (number_to_decimal_form_string_x_esm_test.call(isValid, workingValue) === false) {
  ...
  if (number_to_decimal_form_string_x_esm_charAt.call(workingValue, 0) === hyphenMinus) {
  ...
  if (pointIndex > -1) {
    workingValue = number_to_decimal_form_string_x_esm_replace.call(workingValue, decimalMark, emptyString);
  }
  ...
  if (index > 0) {
    ...
    exponentIndex += number_to_decimal_form_string_x_esm_castNumber(slice.call(workingValue, index + 1));
  ...
  while (index < leadingZeroIndex && number_to_decimal_form_string_x_esm_charAt.call(workingValue, index) === zeroSymbol) {
    index += 1;
  }
  ...
  if (index === leadingZeroIndex) {
    ...
    if (leadingZeroIndex > 0) {
      do {
        leadingZeroIndex -= 1;
      } while (number_to_decimal_form_string_x_esm_charAt.call(workingValue, leadingZeroIndex) === zeroSymbol && leadingZeroIndex > 0);
    }
    ...
    while (index <= leadingZeroIndex) {
      coefficient[position] = number_to_decimal_form_string_x_esm_castNumber(number_to_decimal_form_string_x_esm_charAt.call(workingValue, index));
      position += 1;
      index += 1;
    }
  }
  ...
  if (exponent < 0) {
    ...
    decimalForm = number_to_decimal_form_string_x_esm_charAt.call(decimalForm, 0) + decimalMark + slice.call(decimalForm, 1);
  }

  return sign < 0 ? hyphenMinus + decimalForm : decimalForm;
};

/* harmony default export */ var number_to_decimal_form_string_x_esm = (number_to_decimal_form_string_x_esm_toDecimalFormString);
...
// CONCATENATED MODULE: ./dist/number-format-x.esm.js
...
var MAX_TO_FIXED = 20;
var toFixed = simple_methodize_x_esm(MAX_TO_FIXED.toFixed);
var numberToString = simple_methodize_x_esm(MAX_TO_FIXED.toString);
var SECTION_DELIMITER = ',';
var DECIMAL_DELIMITER = '.';
var number_format_x_esm_EMPTY_STRING = '';
var number_format_x_esm_replace = simple_methodize_x_esm(number_format_x_esm_EMPTY_STRING.replace);
var number_format_x_esm_split = simple_methodize_x_esm(number_format_x_esm_EMPTY_STRING.split);
var strSlice = simple_methodize_x_esm(number_format_x_esm_EMPTY_STRING.slice);
var number_format_x_esm_join = simple_methodize_x_esm([].join);
...
var number_format_x_esm_getOpts = function getOpts(args) {
  return {
    ...
    sectionDelimiter: number_format_x_esm_isArgSupplied(args, 3) ? to_string_x_esm(args[3]) : SECTION_DELIMITER,
    decimalDelimiter: number_format_x_esm_isArgSupplied(args, 4) ? to_string_x_esm(args[4]) : DECIMAL_DELIMITER
  };
};

var number_format_x_esm_getFixed = function getFixed(number, digits) {
  var fixed = number_to_decimal_form_string_x_esm(toFixed(number, digits));

  if (digits > 0) {
    var parts = number_format_x_esm_split(fixed, DECIMAL_DELIMITER);
    parts[1] = strSlice("".concat(parts[1] || number_format_x_esm_EMPTY_STRING, "00000000000000000000"), 0, digits);
    return number_format_x_esm_join(parts, DECIMAL_DELIMITER);
  }
...
var getFixedReplaced = function getFixedReplaced(fixed, decimalDelimiter) {
  ...
  return number_format_x_esm_replace(fixed, DECIMAL_DELIMITER, decimalDelimiter);
};
...
var number_format_x_esm_numberFormat = function numberFormat(value) {
  var number = to_number_x_esm(value);
  ...
  var digits = number_format_x_esm_isArgSupplied(arguments, 1) ? math_clamp_x_esm(to_integer_x_esm(arguments[1]), 0, MAX_TO_FIXED) : 2;
  ...
  return number_format_x_esm_replace(getFixedReplaced(fixed, decimalDelimiter), getRegex(digits, sectionLength), "$&".concat(sectionDelimiter));
};
...
//# sourceMappingURL=number-format-x.js.map