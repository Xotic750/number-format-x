/*!
{
  ...
  "date": "2019-08-28T18:21:49.069Z",
  "describe": "",
  "description": "Format a number.",
  "file": "number-format-x.js",
  "hash": "0fa1ca805bc555afe24d",
  "license": "MIT",
  "version": "4.1.2"
}
*/
...
var number_to_decimal_form_string_x_esm_methodizedTest = simple_methodize_x_esm(VALID_RX.test);
...
var number_to_decimal_form_string_x_esm_toDecimalFormString = function toDecimalFormString(value) {
  ...
  if (workingValue === 0 && 1 / workingValue < 0) {
    ...
    if (number_to_decimal_form_string_x_esm_methodizedTest(VALID_RX, workingValue) === false) {
  ...
  if (index > 0) {
    ...
    exponentIndex += number_to_decimal_form_string_x_esm_castNumber(slice(workingValue, index + 1));
  ...
  if (index === leadingZeroIndex) {
    ...
    while (index <= leadingZeroIndex) {
      coefficient[position] = number_to_decimal_form_string_x_esm_castNumber(charAt(workingValue, index));
      position += 1;
      index += 1;
    }
  }
