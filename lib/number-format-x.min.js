 ...
 */
"use strict";var cachedCtrs=_dereq_("cached-constructors-x"),RE=cachedCtrs.RegExp,toFixed=cachedCtrs.Number.prototype.toFixed,numberToString=cachedCtrs.Number.prototype.toString,replace=cachedCtrs.String.prototype.replace,split=cachedCtrs.String.prototype.split,strSlice=cachedCtrs.String.prototype.slice,join=cachedCtrs.Array.prototype.join,toNumber=_dereq_("to-number-x").toNumber2018,toInteger=_dereq_("to-integer-x").toInteger2018,numberIsFinite=_dereq_("is-finite-x"),numToString=_dereq_("number-to-decimal-form-string-x"),toStr=_dereq_("to-string-x"),mathClamp=_dereq_("math-clamp-x"),isNil=_dereq_("is-nil-x"),isArgSupplied=function _isArgSupplied(args,index){return args.length>index&&!1===isNil(args[index])};module.exports=function numberFormat(value){var number=toNumber(value);if(!1===numberIsFinite(number))return numberToString.call(number);var digits=isArgSupplied(arguments,1)?mathClamp(toInteger(arguments[1]),0,20):2,fixed=numToString(toFixed.call(number,digits));if(digits>0){var parts=split.call(fixed,".");parts[1]=strSlice.call((parts[1]||"")+"00000000000000000000",0,digits),fixed=join.call(parts,".")}var sectionLength=isArgSupplied(arguments,2)?toInteger(arguments[2]):3,sectionDelimiter=isArgSupplied(arguments,3)?toStr(arguments[3]):",",decimalDelimiter=isArgSupplied(arguments,4)?toStr(arguments[4]):".";return replace.call("."===decimalDelimiter?fixed:replace.call(fixed,".",decimalDelimiter),new RE("\\d(?=(\\d{"+sectionLength+"})+"+(digits>0?"\\D":"$")+")","g"),"$&"+sectionDelimiter)}},{"cached-constructors-x":3,"is-finite-x":9,"is-nil-x":12,"math-clamp-x":16,"number-to-decimal-form-string-x":20,"to-integer-x":26,"to-number-x":27,"to-string-x":30}],2:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var requireObjectCoercible=_dereq_("require-object-coercible-x"),toStr=_dereq_("to-string-x");module.exports=function requireCoercibleToString(value){return toStr(requireObjectCoercible(value))}},{"require-object-coercible-x":24,"to-string-x":30}],24:[function(_dereq_,module,exports){/**
 ...
 */
"use strict";var isNull=_dereq_("lodash.isnull"),isUndefined=_dereq_("validate.io-undefined"),toStr={}.toString;module.exports=function toStringTag(value){return isNull(value)?"[object Null]":isUndefined(value)?"[object Undefined]":toStr.call(value)}},{"lodash.isnull":15,"validate.io-undefined":34}],30:[function(_dereq_,module,exports){/**
 ...
 * @module to-string-x
 */
"use strict";var castString="".constructor,isSymbol=_dereq_("is-symbol");module.exports=function ToString(value){if(isSymbol(value))throw new TypeError("Cannot convert a Symbol value to a string");return castString(value)}},{"is-symbol":14}],31:[function(_dereq_,module,exports){/**
 ...
 * @module trim-right-x
 */
"use strict";var requireCoercibleToString=_dereq_("require-coercible-to-string-x"),Rx=_dereq_("cached-constructors-x").RegExp,reRight2016=new Rx("["+_dereq_("white-space-x").string2016+"]+$"),reRight2018=new Rx("["+_dereq_("white-space-x").string2018+"]+$"),replace="".replace,$trimRight2018=function trimRight2018(string){return replace.call(requireCoercibleToString(string),reRight2018,"")};module.exports={trimRight:$trimRight2018,trimRight2016:function trimRight2016(string){return replace.call(requireCoercibleToString(string),reRight2016,"")},trimRight2018:$trimRight2018}},{"cached-constructors-x":3,"require-coercible-to-string-x":23,"white-space-x":35}],33:[function(_dereq_,module,exports){/**
